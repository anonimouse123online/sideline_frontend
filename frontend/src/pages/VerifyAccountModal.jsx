...
const handleApprove = async () => {
  try {
    const res = await fetch(`${API_URL}/api/applicants/${userId}/sent-email`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        <p>
          To verify your account, please send an email to the team including your ID, selfie, and social media account.
        </p>

        <p><strong>Have you sent the verification email?</strong></p>
        <select
        ...
        >
          ...
          <option value="yes">
            Yes, I sent the email. Please check.
          </option>
          <option value="no">
